...
local create_claude_config = function(model)
  local cai = create_avante_config(model, "https://api.anthropic.com")
  cai['api_key_name'] = "cmd:pass claude"
  return cai
end
...
return {
  ...
  opts = {
    ...
    claude = {
      api_key_name = "cmd:pass claude",
    },
    vendors = {
      ---@type AvanteProvider
      qwen = create_ollama_config("localhost", "qwen2.5-coder:7b"),
      codestral = create_ollama_config("Tabi", "codestral"),
      commandR = create_ollama_config("Tabi", "command-r"),
      yi = create_ollama_config("Tabi", "yi:34b"),
      ---@type AvanteProvider
